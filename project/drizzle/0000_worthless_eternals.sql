...
CREATE INDEX "stages_project_position_idx" ON "stages" USING btree ("project_id","position");--> statement-breakpoint
CREATE INDEX "task_assignees_user_id_idx" ON "task_assignees" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "tasks_stage_position_idx" ON "tasks" USING btree ("stage_id","position");--> statement-breakpoint
