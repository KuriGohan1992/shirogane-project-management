...
function CollaboratorIdentity({ user }: { user: UserProfileSummary }) {
	return (
		<>
								...
								<div className="flex min-w-0 flex-col gap-2 sm:flex-row sm:items-start">
									<div className="min-w-0 flex-1">
										<input
											...
											className={cn(
												"h-9 w-full rounded-lg border border-input bg-card px-3 text-sm outline-none transition focus:ring-2 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-60",
									...
									<Button
										type="submit"
										disabled={pending}
										className="h-9 w-full shrink-0 px-5 sm:w-auto"
									>
													...
													<AlertDialog>
														...
														<AlertDialogContent>
															<AlertDialogHeader>
																...
																<AlertDialogDescription>
																	They will lose access to this project, and
																	their task assignments in this project will be
																	removed.
																</AlertDialogDescription>
															</AlertDialogHeader>
